#ifndef AUV_WRNCH_CTRL_HPP
#define AUV_WRNCH_CTRL_HPP
...
{
    class BodyWrenchController : public controller_interface::ChainableControllerInterface
    {
    private:
        ...
        auv_wrench_controller::Params params_;

    public:
        BodyWrenchController(/* args */);
        ~BodyWrenchController();
